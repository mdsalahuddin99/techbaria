        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              আপনার account-এর সব row (products, categories, sales, customers, suppliers, purchases, expenses, accounts, branches, settings ইত্যাদি) cloud থেকে স্থায়ীভাবে delete হবে। এটি undo করা যাবে না।
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
