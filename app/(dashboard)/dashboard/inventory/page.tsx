...
import { Search, Plus, History, Pencil, Trash2, PackagePlus, Tag, Check, X, ScanLine, Printer, ChevronRight, CornerDownRight } from "lucide-react";
...
import { useInventoryStats, useAdjustments, useInventoryActions } from "@/features/inventory/hooks";
import {
...
export default function Inventory() {
  ...
  const { stockValue, lowCount, outCount } = useInventoryStats();
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Inventory"
        description="Track stock value, manage categories, and audit adjustments."
      />
