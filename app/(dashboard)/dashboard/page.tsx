...
export default function Dashboard() {
  ...
  const stockDonut = useMemo(() => {
    ...
    return [
      { name: "Healthy", value: healthy, color: "#0f766e" }, // Teal-700
      { name: "Low Stock", value: low, color: "#f59e0b" }, // Amber
      { name: "Out of Stock", value: outOf, color: "#ef4444" }, // Red
      ...(rest > 0 ? [{ name: "Other", value: rest, color: "#ccfbf1" }] : []), // Teal-100
    ].filter((d) => d.value > 0);
  }, [products, lowStock]);
