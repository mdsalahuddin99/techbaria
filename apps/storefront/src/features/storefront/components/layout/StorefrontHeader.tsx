        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 py-2 sm:py-0 min-h-[4rem] sm:h-20 flex items-center justify-between gap-2 sm:gap-6">
          ...
          <Sheet>
            <SheetTrigger asChild>
              <button
                className="md:hidden p-2 -ml-1 rounded-full transition-all duration-300 hover:bg-emerald-50 text-slate-700 hover:text-emerald-600 shrink-0"
                aria-label="Menu"
              >
          ...
          <SmartSearch className="flex-1 min-w-0 sm:max-w-xl md:ml-4 lg:ml-8 transition-all duration-300" />
