...
export const translations = {
  ...
  "nav.group.catalog": { en: "Catalog", bn: "ক্যাটালগ" },
  "nav.group.sales": { en: "Sales", bn: "বিক্রয়" },
  "nav.group.purchases": { en: "Purchasing", bn: "ক্রয়" },
  "nav.group.ecommerce": { en: "E-Commerce", bn: "ই-কমার্স" },
  "nav.group.inventory": { en: "Inventory", bn: "ইনভেন্টরি" },
  "nav.group.warranty": { en: "Warranty", bn: "ওয়ারেন্টি" },
  "nav.group.people": { en: "Parties", bn: "পার্টি" },
  "nav.group.finance": { en: "Finance", bn: "অর্থায়ন" },
  "nav.group.reports": { en: "Reports", bn: "রিপোর্ট" },
  ...
  "nav.productList": { en: "Product List", bn: "পণ্যের তালিকা" },
  "nav.newPurchase": { en: "New Purchase", bn: "নতুন ক্রয়" },
  "nav.purchaseHistory": { en: "Purchase History", bn: "ক্রয়ের ইতিহাস" },
  ...
  "nav.newCustomer": { en: "New Customer", bn: "নতুন কাস্টমার" },
  "nav.customerList": { en: "Customer List", bn: "কাস্টমার তালিকা" },
  "nav.purchases": { en: "Purchases", bn: "ক্রয়" },
  "nav.suppliers": { en: "Suppliers", bn: "সরবরাহকারী" },
  "nav.newSupplier": { en: "New Supplier", bn: "নতুন সরবরাহকারী" },
  "nav.supplierList": { en: "Supplier List", bn: "সরবরাহকারী তালিকা" },
