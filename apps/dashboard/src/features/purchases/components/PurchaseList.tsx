    ...
    <>
      <Card className="p-3">
        <div className="flex flex-wrap gap-2 items-center">
          ...
          {!searchTerm.trim() && statusFilter === "All" && filtered.length >= 15 && (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <div className="flex items-center gap-1 ml-2" onClick={(e) => e.stopPropagation()}>
                    ...
                    <Button size="icon" variant="ghost" className="h-8 w-8 text-destructive" onClick={() => window.confirm("Are you sure you want to delete this?") && onDelete(po.id)} title="Delete">
